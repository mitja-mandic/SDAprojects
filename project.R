...
matplot(t(cbind(X,y)), lty=1, type="l",col = y,xlab = "Wavelength",ylab="",main = "Spectra")
legend("topleft",legend=c("D","H","Ha","E"),col=y,type="l")
...
plot(train.pca$scores, main = "Classic PCA Scores", pch=19)
summary(train.pca)
